...
SUBROUTINE read_vtk(fun, fl, array, dims, spcng, size, fov, bnds, log_un, status)
  ...
  INTEGER  (KIND=INT32)                                 , OPTIONAL, INTENT(OUT)    :: size ! int32 mpi!
  REAL     (KIND=REAL64), DIMENSION(3)                  , OPTIONAL, INTENT(OUT)    :: fov
  INTEGER  (KIND=INT64) , DIMENSION(3,2)                , OPTIONAL, INTENT(OUT)    :: bnds
